...
def getSavePath():
    dir_name = './{}_struct{}_featureNum{}_bottleneck{}_imgsize{}_loss{}/'.format(args.dataset,
                                 args.structure, args.num_features, args.bottleneck, 
                                 args.image_size, args.losstype)
...
def get_gloss(type, dis_fake, dis_real):
    if type == 'log':
